...
const plans: Plan[] = [
  {
    ...
    price: 0,
    period: 'forever',
    description: 'Get started with multi-agent debates',
    cta: 'Current Plan',
    features: [
      { text: '10 debates / month', included: true },
      { text: '3 agents per debate', included: true },
      { text: 'Public debates only', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '5 agents per debate', included: true },
      { text: 'Private debates', included: true },
