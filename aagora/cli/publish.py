"""
aagora publish - Generate shareable debate reports.

Creates beautiful, interactive HTML/Markdown reports from debate traces
that can be shared, embedded, or published.

Usage:
    aagora publish <debate-id> --format html --output ./reports/
    aagora publish latest --format md  # Most recent debate
"""
...
from aagora.core import DebateResult
from aagora.debate.traces import DebateTrace
...
<head>
    ...
    <title>aagora Debate: {result.task[:50]}...</title>
    <style>
        :root {{
            --primary: #6366f1;
            --secondary: #8b5cf6;
...
<body>
    <div class="container">
        <header>
            <h1>🏛️ aagora Debate</h1>
            <div class="meta">Multi-Agent Deliberation • {datetime.now().strftime('%Y-%m-%d %H:%M')}</div>
        </header>
        ...
        <footer>
            Generated by <a href="https://github.com/an0mium/aagora">aagora</a> v0.07 •
...
*Generated by [aagora](https://github.com/an0mium/aagora) v0.07 - Multi-Agent Debate Framework*
"""
    return md
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    aagora publish --format html --output ./reports/
    aagora publish --format md
    aagora publish --format json --output ./api/
        """,
    )
    parser.add_argument(
        "--format", "-f",
    ...
    if args.demo:
        ...
        from aagora.core import Message, Critique
