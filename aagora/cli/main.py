...
def cmd_export(args):
    ...
    from pathlib import Path
    from aagora.export.artifact import DebateArtifact, ArtifactBuilder, ConsensusProof
    ...
    if args.demo:
        ...
        from aagora.core import DebateResult, Message, Critique
...
- Include graceful degradation mode""",
        ...
        if args.debate_id:
            ...
            from aagora.debate.traces import list_traces, DebateReplayer

            try:
                replayer = DebateReplayer.from_database(
                    f"trace-{args.debate_id}",
                    args.db or "aagora_traces.db"
                )
    ...
    if format_type == "html":
        ...
        from aagora.cli.publish import generate_markdown_report
        from aagora.core import DebateResult, Message
