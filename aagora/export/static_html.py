...
from aagora.export.artifact import DebateArtifact
...
<head>
    ...
    <title>aagora Debate: {self._escape(self.artifact.task[:50])}...</title>
...
<footer>
    <p>
        Generated by <a href="https://github.com/an0mium/aagora">aagora</a> {self.artifact.generator} |
...
console.log('aagora debate viewer loaded. Artifact:', artifactData.artifact_id);
</script>"""
